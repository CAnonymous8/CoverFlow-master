...
public class CoverFlowView extends RecyclerView {
    ...
    public boolean drawChild(Canvas canvas, View child, long drawingTime) {
        ...
        if (orientation == HORIZONTAL) {
            prepareMatrix(canvas,mMatrix, distanceX, getWidth() / 2);
        } else {
            prepareMatrix(canvas,mMatrix, distanceY, getHeight() / 2);
        }
    ...
    private void prepareMatrix(Canvas canvas,final Matrix outMatrix, int distance, int r) {
        //clip the distance
    ...
    public void setOrientation(int orientation) {
        ...
        if (orientation == VERTICAL) {
            ...
            itemDecoration = new DividerItemDecoration(0, 15);
        } else {
            layoutManager = new LinearLayoutManager(getContext(), LinearLayoutManager.HORIZONTAL, false);
            itemDecoration = new DividerItemDecoration(15, 0);
        }
